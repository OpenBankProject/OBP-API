...
private def saveTransaction(fromAccount: AccountType, toAccount: AccountType, amt: BigDecimal, description : String): Box[TransactionId] = {
    ...
    object Tags {
      ...
      val CTRL_SUM =                      "CTRL_SUM"
      val PAYMENT_REFERENCE =             "PAYMENT_REFERENCE"
      val CTRL =                          "CTRL"
      val EXECUTION_DATE =                "EXECUTION_DATE"
      val DEBTOR_NAME =                   "DEBTOR_NAME"
      val DEBTOR_ACCOUNT_NUMBER =         "DEBTOR_ACCOUNT_NUMBER"
      val DEBTOR_ACCOUNT_CURRENCY =       "DEBTOR_ACCOUNT_CURRENCY"
      val DEBTOR_BRANCH =                 "DEBTOR_BRANCH"
      val TRANSACTION_INSTRUCTION_ID =    "TRANSACTION_INSTRUCTION_ID"
      val TRANSACTION_ENDTOEND_ID =       "TRANSACTION_ENDTOEND_ID"
      val TRANSACTION_CURRENCY =          "TRANSACTION_CURRENCY"
      val TRANSACTION_AMOUNT =            "TRANSACTION_AMOUNT"
      val TRANSACTION_FEE_CURRENCY =      "TRANSACTION_FEE_CURRENCY"
      val TRANSACTION_FEE_AMOUNT =        "TRANSACTION_FEE_AMOUNT"
      val BENEFICIARY_BRANCH =            "BENEFICIARY_BRANCH"
      val BENEFICIARY_NAME =              "BENEFICIARY_NAME"
      val BENEFICIARY_ACCOUNT_NUMBER =    "BENEFICIARY_ACCOUNT_NUMBER"
      val BENEFICIARY_ACCOUNT_CURRENCY =  "BENEFICIARY_ACCOUNT_CURRENCY"
      val LABEL_CREDIT_TRANSFER =         "LABEL_CREDIT_TRANSFER"
    }
