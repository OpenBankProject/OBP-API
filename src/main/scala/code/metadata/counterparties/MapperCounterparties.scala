...
object MapperCounterparties extends Counterparties with MdcLoggable {
  override def getOrCreateMetadata(originalPartyBankId: BankId, originalPartyAccountId: AccountId, otherPartyLabel:String, otherPartyThisAccountId: String): Box[CounterpartyMetadata] = {
    ...
    def findMappedCounterpartyMetadata(
      ...
      otherPartyThisAccountId: String
    ) : Box[MappedCounterpartyMetadata] = {
      MappedCounterpartyMetadata.find(
        By(MappedCounterpartyMetadata.thisBankId, originalPartyBankId.value),
        By(MappedCounterpartyMetadata.thisAccountId, originalPartyAccountId.value),
        By(MappedCounterpartyMetadata.holder, otherPartyLabel),
        By(MappedCounterpartyMetadata.accountNumber, otherPartyThisAccountId))
    }

    val existing = findMappedCounterpartyMetadata(originalPartyBankId, originalPartyAccountId, otherPartyLabel,otherPartyThisAccountId)
