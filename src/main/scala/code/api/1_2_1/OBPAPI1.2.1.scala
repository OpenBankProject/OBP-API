...
object OBPAPI1_2_1 extends OBPRestHelper with APIMethods121 with Loggable {
  ...
  val routes = List(
    ...
    Implementations1_2_1.getTransactionsForBankAccount(code.api.v1_2_1.JSONFactory.createTransactionsJSON _),
    Implementations1_2_1.getTransactionByIdForBankAccount(code.api.v1_2_1.JSONFactory.createTransactionJSON _),
