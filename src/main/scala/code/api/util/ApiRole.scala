...
object ApiRole {
  ...
  case class CanModifyUserAuthContext(requiresBankId: Boolean = false) extends ApiRole
  lazy val canModifyUserAuthContext = CanModifyUserAuthContext()
