...
object OBPAPI1_3_0 extends OBPRestHelper with APIMethods130 with APIMethods121 with Loggable {
  ...
  val routes = List(
    ...
    Implementations1_2_1.getTransactionsForBankAccount(JSONFactory1_3_0.createTransactionsJSON _),
    Implementations1_2_1.getTransactionByIdForBankAccount(JSONFactory1_3_0.createTransactionJSON _),
    ...
    Implementations1_3_0.makePayment, //TODO: add v1.3.0 "challenges"
