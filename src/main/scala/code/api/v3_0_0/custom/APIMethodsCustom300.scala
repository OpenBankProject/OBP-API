...
trait CustomAPIMethods300 {
  ...
  val ImplementationsCustom3_0_0 = new Object() {
    ...
    def endpointsOfCustom3_0_0 = createTransactionRequestCustom ::
      answerTransactionRequestChallengeCustom :: 
      Nil
    ...
    resourceDocs += ResourceDoc(
      ...
      "POST",
      "/custom/banks/BANK_ID/accounts/ACCOUNT_ID/VIEW_ID/transaction-request-types/TRANSACTION_REQUEST_TYPE/transaction-requests/TRANSACTION_REQUEST_ID/challenge",
    ...
    lazy val answerTransactionRequestChallengeCustom: PartialFunction[Req, Box[User] => Box[JsonResponse]] = {
      case "custom" :: "banks" :: BankId(bankId) :: "accounts" :: AccountId(accountId) :: ViewId(viewId) :: "transaction-request-types" ::
