...
class Counterparty(
                    ...
                    val thisBankId : BankId, // These 2 fields specify the account that uses this Counterparty 
                    val thisAccountId: AccountId,
                    val otherBankId : BankId, // These 3 fields specify the internal location of the account for the counterparty if it is known. It could be at OBP in which case hasBankId and hasAccountId would refer to an OBP account
                    val otherAccountId: AccountId, 
                    val otherAccountProvider: String,
