    ...
    DbFunction.tableExistsByName("mappedconsent") match {
      case true =>
        ...
        try {
          ...
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() => backupMappedConsent)).append("\n")
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() => backupConsentItem)).append("\n")
          ...
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() => addColumn)).append("\n")
          ...
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() => backfillConsents)).append("\n")
          ...
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() => setNotNull)).append("\n")
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() =>
          ...
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() => alterConsentItem)).append("\n")
          ...
          sqlLog.append(DbFunction.maybeWrite(true, DbFunction.infoF _)(() => backfillConsentItem)).append("\n")
