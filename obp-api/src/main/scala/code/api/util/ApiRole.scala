...
object ApiRole extends MdcLoggable{
  ...
  case class CanSeeAccountAccessForOneUser(requiresBankId: Boolean = false) extends ApiRole
  lazy val canSeeAccountAccessForOneUser = CanSeeAccountAccessForOneUser()
