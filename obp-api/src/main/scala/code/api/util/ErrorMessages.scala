...
object ErrorMessages {
  ...
  val AccountFirehoseNotAllowedOnThisInstance = "OBP-00009: Firehose is not allowed on this instance. Please set allow_account_firehose = true in props files. "
  ...
  val CustomerFirehoseNotAllowedOnThisInstance = "OBP-00012: Firehose is not allowed on this instance. Please set allow_customer_firehose = true in props files. "
