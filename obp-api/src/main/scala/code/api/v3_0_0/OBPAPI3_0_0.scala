...
All v3.0.0 endpoints have been migrated to Http4s300 — this object is retained
only for resource-doc aggregation and the Lift dispatch registry.
 */
object OBPAPI3_0_0 extends OBPRestHelper with MdcLoggable with VersionedOBPApis {
