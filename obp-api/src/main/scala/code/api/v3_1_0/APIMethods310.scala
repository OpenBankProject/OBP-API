        ...
        cc => implicit val ec = EndpointContext(Some(cc))
          for {
            ...
            updatedConsumer <- Future {
              Consumers.consumers.vend.updateConsumer(consumer.id.get, None, None, Some(putData.enabled), None, None, None, None, None, None, None,None, None, None) ?~! "Cannot update Consumer"
            }
          } yield {
