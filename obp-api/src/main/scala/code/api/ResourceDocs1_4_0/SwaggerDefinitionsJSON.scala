...
import code.api.v4_0_0.{APIInfoJson400, EnergySource400, HostedAt400, HostedBy400, NewModeratedCoreAccountJsonV400}
...
object SwaggerDefinitionsJSON {
  ...
  val newModeratedCoreAccountJsonV400 = NewModeratedCoreAccountJsonV400(
    id = accountIdExample.value,
    bank_id= bankIdExample.value,
    label= labelExample.value,
    number= accountNumberExample.value,
