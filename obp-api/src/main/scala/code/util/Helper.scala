...
object Helper extends Loggable {
  ...
  def isValidInternalRedirectUrl(url: String) : Boolean = {
    ...
    val validUrls = List("/","/oauth/authorize","/consumer-registration","/dummy-user-tokens","/create-sandbox-account", "/add-user-auth-context-update-request","/otp","/terms-and-conditions")
