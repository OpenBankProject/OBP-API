...
trait Connector extends MdcLoggable {
  ...
  */
  ...
  def getBankLevelEndpointTag(bankId:String, endpointTagId : String, callContext: Option[CallContext]) : OBPReturnType[Box[EndpointTagT]] = Future(Failure(setUnimplementedError))
