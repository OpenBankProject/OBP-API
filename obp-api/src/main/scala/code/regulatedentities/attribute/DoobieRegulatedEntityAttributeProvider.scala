...
object DoobieRegulatedEntityAttributeProvider extends RegulatedEntityAttributeProviderTrait {
  ...
  private def rowOf(r: (Option[String], Option[String], Option[String], Option[String], Option[String], Option[Boolean])): RegulatedEntityAttributeRow =
    RegulatedEntityAttributeRow(
      regulatedEntityId = RegulatedEntityId(r._1.orNull),
      regulatedEntityAttributeId = r._2.orNull,
      attributeType = RegulatedEntityAttributeType.withName(r._3.orNull),
      name = r._4.orNull,
      value = r._5.orNull,
      isActive = r._6
    )
