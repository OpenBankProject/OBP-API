...
object UserReference {
  ...
  case object MetricArchiveUserId                                  extends UserReference(UseAuthenticatedUserId, "code.metrics.MetricArchive", List("userId"), "as MetricUserId")
  case object ConnectorTraceUserId                                 extends UserReference(UseAuthenticatedUserId, "code.metrics.ConnectorTrace", List("userId"), "as MetricUserId")
  ...
  case object EntitlementUserId                                    extends UserReference(UseOnBehalfOfUserId   , "code.entitlement.MappedEntitlement", List("mUserId"), "the role holder; the consent-engine case is EntitlementUserIdConsentScope")
  ...
  case object UserAuthContextUpdateUserId                          extends UserReference(UseOnBehalfOfUserId   , "code.context.MappedUserAuthContextUpdate", List("mUserId"), "as UserAuthContextUserId")
  ...
  case object SystemAccountNotificationWebhookCreatedByUserId      extends UserReference(UseOnBehalfOfUserId   , "code.webhook.SystemAccountNotificationWebhook", List("CreatedByUserId"), "as AccountWebhookCreatedByUserId")
  case object BankAccountNotificationWebhookCreatedByUserId        extends UserReference(UseOnBehalfOfUserId   , "code.webhook.BankAccountNotificationWebhook", List("CreatedByUserId"), "as AccountWebhookCreatedByUserId")
