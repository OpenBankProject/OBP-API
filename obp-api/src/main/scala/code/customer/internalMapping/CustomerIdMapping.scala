 ...
 * CustomerReference is just a plain text from bank. Bank need prepare it and make it unique for each Customer.
 *
...
trait CustomerIdMapping {
   ...
   * @return  It can be concatenated of real bank customer data: eg: CustomerReference =  customerNumber + customerCode + customerType
   */
