...
final case class ListChannelsResponse(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ListChannelsResponse] {
    @transient
...
object ListChannelsResponse extends scalapb.GeneratedMessageCompanion[code.obp.grpc.signal.api.ListChannelsResponse] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): code.obp.grpc.signal.api.ListChannelsResponse =
