...
final case class ListChannelsRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[ListChannelsRequest] {
    @transient
...
object ListChannelsRequest extends scalapb.GeneratedMessageCompanion[code.obp.grpc.signal.api.ListChannelsRequest] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): code.obp.grpc.signal.api.ListChannelsRequest =
