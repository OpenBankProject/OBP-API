...
final case class SignalChannelInfo(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SignalChannelInfo] {
    @transient
...
object SignalChannelInfo extends scalapb.GeneratedMessageCompanion[code.obp.grpc.signal.api.SignalChannelInfo] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): code.obp.grpc.signal.api.SignalChannelInfo =
