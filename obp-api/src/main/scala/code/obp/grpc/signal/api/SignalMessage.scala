...
final case class SignalMessage(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[SignalMessage] {
    @transient
...
object SignalMessage extends scalapb.GeneratedMessageCompanion[code.obp.grpc.signal.api.SignalMessage] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): code.obp.grpc.signal.api.SignalMessage =
