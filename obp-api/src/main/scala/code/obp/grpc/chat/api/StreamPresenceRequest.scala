...
final case class StreamPresenceRequest(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[StreamPresenceRequest] {
    @transient
    ...
    // @@protoc_insertion_point(GeneratedMessage[code.obp.grpc.chat.g1.StreamPresenceRequest])
}
...
object StreamPresenceRequest extends scalapb.GeneratedMessageCompanion[code.obp.grpc.chat.api.StreamPresenceRequest] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): code.obp.grpc.chat.api.StreamPresenceRequest = {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = ChatProto.javaDescriptor.getMessageTypes().get(4)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = ChatProto.scalaDescriptor.messages(4)
  ...
  def of(
    chatRoomId: _root_.scala.Predef.String
  ): _root_.code.obp.grpc.chat.api.StreamPresenceRequest = _root_.code.obp.grpc.chat.api.StreamPresenceRequest(
    chatRoomId
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[code.obp.grpc.chat.g1.StreamPresenceRequest])
}
