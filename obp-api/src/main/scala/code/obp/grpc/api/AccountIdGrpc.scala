...
final case class AccountIdGrpc(
    ...
    ) extends scalapb.GeneratedMessage with scalapb.lenses.Updatable[AccountIdGrpc] {
    @transient
    ...
    def companion: code.obp.grpc.api.AccountIdGrpc.type = code.obp.grpc.api.AccountIdGrpc
    // @@protoc_insertion_point(GeneratedMessage[code.obp.grpc.AccountIdGrpc])
}
...
object AccountIdGrpc extends scalapb.GeneratedMessageCompanion[code.obp.grpc.api.AccountIdGrpc] {
  ...
  def parseFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): code.obp.grpc.api.AccountIdGrpc = {
  ...
  def of(
    value: _root_.scala.Predef.String
  ): _root_.code.obp.grpc.api.AccountIdGrpc = _root_.code.obp.grpc.api.AccountIdGrpc(
    value
  )
  // @@protoc_insertion_point(GeneratedMessageCompanion[code.obp.grpc.AccountIdGrpc])
}
