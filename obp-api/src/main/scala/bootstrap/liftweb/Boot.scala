  ...
  def boot {
    ...
    val sitemap = List(
          ...
          Menu.params[(String, String, String, String)]("Send initiatedPayment OTP", "initiatedPayment OTP",
            { case paymentService :: paymentProduct :: paymentId :: authorisationId :: Nil => Full(paymentService, paymentProduct, paymentId, authorisationId) },
            { case (paymentService, paymentProduct, paymentId, authorisationId) => paymentService :: paymentProduct :: paymentId :: authorisationId :: Nil }
