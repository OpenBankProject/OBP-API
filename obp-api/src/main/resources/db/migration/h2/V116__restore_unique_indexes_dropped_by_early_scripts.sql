...
CREATE UNIQUE INDEX IF NOT EXISTS "PUBLIC"."MAPPEDATM_MBANKID_MATMID"
    ON "PUBLIC"."MAPPEDATM"("MBANKID" NULLS FIRST, "MATMID" NULLS FIRST);
CREATE UNIQUE INDEX IF NOT EXISTS "PUBLIC"."MAPPEDCOMMENT_APIID"
    ON "PUBLIC"."MAPPEDCOMMENT"("APIID" NULLS FIRST);
CREATE UNIQUE INDEX IF NOT EXISTS "PUBLIC"."MAPPEDTAG_TAGID"
    ON "PUBLIC"."MAPPEDTAG"("TAGID" NULLS FIRST);
CREATE UNIQUE INDEX IF NOT EXISTS "PUBLIC"."MAPPEDTRANSACTIONIMAGE_IMAGEID"
    ON "PUBLIC"."MAPPEDTRANSACTIONIMAGE"("IMAGEID" NULLS FIRST);
CREATE UNIQUE INDEX IF NOT EXISTS "PUBLIC"."CONSENT_ITEM_CONSENT_ITEM_ID"
    ON "PUBLIC"."CONSENT_ITEM"("CONSENT_ITEM_ID" NULLS FIRST);
