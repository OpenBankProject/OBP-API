...
CREATE INDEX IF NOT EXISTS "PUBLIC"."CONNECTOR_TRACE_CORRELATIONID"
    ON "PUBLIC"."CONNECTOR_TRACE"("CORRELATIONID" NULLS FIRST);

CREATE INDEX IF NOT EXISTS "PUBLIC"."CONNECTOR_TRACE_CONNECTORNAME"
    ON "PUBLIC"."CONNECTOR_TRACE"("CONNECTORNAME" NULLS FIRST);

CREATE INDEX IF NOT EXISTS "PUBLIC"."CONNECTOR_TRACE_FUNCTIONNAME"
    ON "PUBLIC"."CONNECTOR_TRACE"("FUNCTIONNAME" NULLS FIRST);

CREATE INDEX IF NOT EXISTS "PUBLIC"."CONNECTOR_TRACE_USERID"
    ON "PUBLIC"."CONNECTOR_TRACE"("USERID" NULLS FIRST);

CREATE INDEX IF NOT EXISTS "PUBLIC"."CONNECTOR_TRACE_BANKID"
    ON "PUBLIC"."CONNECTOR_TRACE"("BANKID" NULLS FIRST);

CREATE INDEX IF NOT EXISTS "PUBLIC"."CONSENT_ITEM_BANK_ID"
    ON "PUBLIC"."CONSENT_ITEM"("BANK_ID" NULLS FIRST);
