...
DROP INDEX IF EXISTS accountidmapping_maccountid_maccountplaintextreference;
DROP INDEX IF EXISTS mappedcustomeridmapping_mcustomerid_mcustomerplaintextreference;
DROP INDEX IF EXISTS transactionidmapping_transactionid_transactionplaintextreference;

CREATE UNIQUE INDEX accountidmapping_maccountplaintextreference
    ON accountidmapping(maccountplaintextreference NULLS FIRST);
CREATE UNIQUE INDEX mappedcustomeridmapping_mcustomerplaintextreference
    ON mappedcustomeridmapping(mcustomerplaintextreference NULLS FIRST);
CREATE UNIQUE INDEX transactionidmapping_transactionplaintextreference
    ON transactionidmapping(transactionplaintextreference NULLS FIRST);
