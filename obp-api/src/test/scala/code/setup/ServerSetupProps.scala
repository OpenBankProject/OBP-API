...
trait ServerSetupProps extends FeatureSpec with SendServerRequests
  ...
  setPropsValues("starConnector_supported_types"->"mapped,internal,rest_vMar2019")
...
trait ServerSetupPropsWithTestData extends ServerSetupProps with DefaultConnectorTestSetup with DefaultUsers{
