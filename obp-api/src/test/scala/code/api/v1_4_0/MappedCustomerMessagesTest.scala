...
import code.customer.{Customers, MappedCustomerMessage}
...
class MappedCustomerMessagesTest extends V140ServerSetup with DefaultUsers {
  ...
  feature("Customer messages") {
    ...
    scenario("Adding a message") {
      ...
      val customer: Box[Customer] = Customers.customerProvider.vend.getCustomerByCustomerNumber(mockCustomerNumber, testBankId1)
