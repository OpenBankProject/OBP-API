...
class DynamicResourceDocTest extends V400ServerSetup {
  ...
  feature("Test the DynamicResourceDoc endpoints") {
    scenario("We create my DynamicResourceDoc and get,update", ApiEndpoint1,ApiEndpoint2, ApiEndpoint3, ApiEndpoint4, VersionOfApi) {
      ...
      dynamicResourceDoc.implementedInApiVersion  should be (postDynamicResourceDoc.implementedInApiVersion)
      ...
      (dynamicResourceDocs \ "implemented_in_api_version").values.toString should equal (postDynamicResourceDoc.implementedInApiVersion)
