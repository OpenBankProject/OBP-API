...
import code.api.util.ApiRole.{CanReadAggregateMetrics, CanReadMetrics}
...
class MetricTest extends V510ServerSetup {
  ...
  object ApiEndpoint2 extends Tag(nameOf(Implementations2_1_0.getMetrics))
  ...
  feature(s"test $ApiEndpoint2 version $VersionOfApi - Authorized access") {
    scenario("We will call the endpoint with user credentials and a proper entitlement", ApiEndpoint1, VersionOfApi) {
      ...
      When("We make a request v5.1.0")
      val request = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("include_app_names", testConsumer.name.get))
      val response = makeGetRequest(req = request)
      Then("We get successful response")
      response.code should equal(200)
      val metricJSON = response.body.extract[MetricsJson]
      metricJSON.metrics.size shouldBe (21)

      When("We make a request v5.1.0")
      val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("include_app_names", s"${testConsumer.name.get},${testConsumer2.name.get}"))
      val response2 = makeGetRequest(request2)
      Then("We get successful response")
      response2.code should equal(200)
      request2.toRequest
      val metricJSON2 = response2.body.extract[MetricsJson]
      metricJSON2.metrics.size shouldBe (22)

      {
        When("We make a request v5.1.0")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("include_app_names", s"${testConsumer.name.get},${testConsumer2.name.get},${testConsumer3.name.get}"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (23)
      }

      {
        Then("we test the include_implemented_by_partial_functions params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("include_implemented_by_partial_functions", "getBanks"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (24)
      }

      {
        Then("we test the include_implemented_by_partial_functions params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("include_implemented_by_partial_functions", "getBanks,getCurrentUser"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (25)
      }

      {
        Then("we test the include_url_patterns params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("include_url_patterns", "%users%"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (26)
      }

      {
        Then("we test the include_url_patterns params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("include_url_patterns", "%users%,%current%"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (27)
      }

      {
        Then("we test the from_date params, we set it 2222, so the result will be always 0")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("from_date", "2222-01-10T01:20:02.900Z"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (0)
      }

      {
        Then("we test the from_date params, we set it 0000, so the result will be always 0")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("to_date", "0000-01-10T01:20:02.900Z"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the consumer_id params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("consumer_id", s"${testConsumer3.id.get}"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (7)
      }

      {
        Then("we test the consumer_id params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("consumer_id", s"${testConsumer2.id.get}"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the user_id params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("user_id", s"${resourceUser3.userId}"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the user_id params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("user_id", s"{${resourceUser2.userId}}"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the anon params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("anon", s"true"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the anon params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("anon", s"false"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size > 25 shouldBe (true)
      }

      {
        Then("we test the url params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("url", "/obp/v5.1.0/banks"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size shouldBe (12)
      }

      {
        Then("we test the app_name params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("app_name", s"${testConsumer2.name.get}"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the app_name params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("app_name", "test5"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the implemented_by_partial_function params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("implemented_by_partial_function", "getBanks"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the implemented_in_version params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("implemented_in_version", "v5.1.0"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size > (21) should be(true)
      }
      {
        Then("we test the implemented_in_version params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("implemented_in_version", "v5.0.0"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size should be(0)
      }
      {
        Then("we test the verb params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("verb", "GET"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the verb params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("verb", "POST"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
      ...
      {
        Then("we test the verb params")
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? List(("correlation_id", "123"))
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
...

      {
        ...
        val request2 = (v5_1_0_Request / "management" / "metrics").GET <@ (user1) <<? params
        val response2 = makeGetRequest(request2)
        Then("We get successful response")
        response2.code should equal(200)
        request2.toRequest
        val metricJSON2 = response2.body.extract[MetricsJson]
        metricJSON2.metrics.size > (0) shouldBe (true)
      }
